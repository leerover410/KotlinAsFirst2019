 ...
 * 1 саженей = 3 аршина = 48 вершков, 1 вершок = 4.445 см.
 */
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg + (min / 60) + (sec / 3600)) * 3.14) / 180
